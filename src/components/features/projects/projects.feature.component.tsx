...
export default function Projects(props: {
  ...
  const projectsPage2 = (props.appState.projects[props.resumeType || 'none'].page2 || [])
    .sort((a, b) => b.start.getTime() - a.start.getTime());
  const highlightedProjects = props.appState.projects[props.resumeType || 'none'].highlighted || [];
 
  const allProjects = ([...projectsPage1, ...projectsPage2, ...highlightedProjects]
  ...
  return <div className={className}>
    ...
    {highlightedProjects.length > 0 ? (<div className={"relative mb-6 " + (projectsPage1.length === 0 ? resumeMarginBottom : '')}>
      ...
      {highlightedProjects.map((project, i) => (
        <div className={(props.resumeType ? 'mb-4 ' : "mb-16 ")} key={i}>
